...
const NavCollapsible = ({ children }) => {
    ...
    return (
        <div className={`fixed w-full md:hidden overscroll-none z-50 text-[#adb6d8] ${collapsed ? 'nav-collapsed' : 'nav-show'}`}>
            ...
            <div className="bg-[#14161f] fixed w-3/4 h-screen z-50 text-light p-3">
                ...
                <div className="flex justify-between items-center">
                    <a href="/">
                        <div className="flex items-center justify-center">
                            ...
                            <h1 className="font-bold text-xl">Krycom</h1>
                        </div>
                    </a>
